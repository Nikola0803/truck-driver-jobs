  ...
  return (
    <>
      <SeoHead
        ...
        description="The page you are looking for does not exist. Browse CDL trucking jobs at TruckDriverJobs.co."
      />
      <div className="relative flex flex-col items-center justify-center h-screen text-center px-4">
        ...
        <div className="relative z-10">
          <h2 className="text-xl md:text-2xl font-semibold mt-6">This page has not been generated</h2>
